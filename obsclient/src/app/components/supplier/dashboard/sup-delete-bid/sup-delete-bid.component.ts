...
@Component({
  selector: "app-sup-delete-bid",
  templateUrl: "./sup-delete-bid.component.html",
  styleUrls: ["./sup-delete-bid.component.css"]
})
export class SupDeleteBidComponent implements OnInit {
  message;
  messageClass;
  foundBid = false;
  processing = false;
